...
class MarineCreatureRepositoryImpl(
    ...
    override suspend fun insert(creature: MarineCreature) = dao.insert(creature.toEntity())
    override suspend fun update(creature: MarineCreature) = dao.update(creature.toEntity())
}